...
RLo = uispinner(UIFigure, "Step", 0.1, "Limits", [0 Inf], "Visible", "off", "Position", [32 221 63 22]);
RHi = uispinner(UIFigure, "Step", 0.1, "Limits", [0 Inf], "Visible", "off", "Position", [97 221 60 22]);

thetaLoHidegLabel = uilabel(UIFigure, "HorizontalAlignment", "right", "Visible", "off", "Position", [55 180 87 22],"Text", "thetaLoHi [deg]");
thetaLo = uispinner(UIFigure, "Limits", [-360 360], "Visible", "off", "Position", [32 149 63 22]);
thetaHi = uispinner(UIFigure, "Limits", [0 360], "Visible", "off", "Position", [97 149 60 22]);

L0LoHimSpinnerLabel = uilabel(UIFigure, "HorizontalAlignment", "right", "Visible", "off", "Position", [67 108 63 22],"Text", "L0LoHi [m]");
L0Lo = uispinner(UIFigure, "Step", 0.1, "Limits", [0 Inf], "Visible", "off", "Position", [32 77 64 22]);
L0Hi = uispinner(UIFigure, "Step", 0.1, "Limits", [0 Inf], "Visible", "off", "Position", [98 77 59 22]);

LL0LoHimLabel = uilabel(UIFigure, "HorizontalAlignment", "right", "Visible", "off", "Position", [60 41 70 22],"Text", "LL0LoHi [m]");
LL0Lo = uispinner(UIFigure, "Limits", [0 Inf], "Visible", "off", "Position", [32 10 64 22], "Step", 0.1);
LL0Hi = uispinner(UIFigure, "Limits", [0 Inf], "Visible", "off", "Position", [98 10 59 22], "Step", 0.1);

% Create TypeofSpringButtonGroup
springGroup = uibuttongroup(UIFigure, "SelectionChangedFcn",...
    @springButtonChange, "Position", [82 448 123 69]);
...
jointGroup = uibuttongroup(UIFigure, "SelectionChangedFcn", @jointButtonChange,"Position", [295 449 196 92]);
...
%HipKnee = uiradiobutton(jointGroup, "Text", "Hip-Knee", "Position", [11 3 106 22]);
...
K1jEditField = uieditfield(UIFigure, 'numeric', "Limits", [0 Inf], "Visible", "off", "Tooltip", {'spring stiffness in [N/m] for a 1-joint compression spring'}, "Position", [362 326 100 22]);

K2jEditFieldLabel  = uilabel(UIFigure, "HorizontalAlignment", "right", "Visible", "off", "Position", [323 292 25 22],"Text", "K2j");
K2jEditField = uieditfield(UIFigure, 'numeric', "Limits", [0 Inf], "Visible", "off", "Tooltip", {'spring stiffness in [N/m] for a 2-joint compression spring'}, "Position", [363 292 100 22]);
...
Border = uibutton(UIFigure, 'push', "Visible", "off", "Enable", "off",...
    "BackgroundColor",[0.8 0.8 0.8], "Tooltip", "These are generic body dimensions for an average man. Values typically do not change. ",...
    "Position",[221 77 310 184], "Text", " ");
