...
S.ColorsR = [0 0.2 0.9; 0 0.7 0; 0.9 0.4 0]; % 3 distinct RGB color spaces for the rotators
S.ColorsY = [1 0.87843 0.40]; % yellow springs
S.ColorsC = [0.0235294 0.8392157 0.627451]; % green 1-joint springs
S.ColorsT = [1 0.572549 0.545098]; % pink 2-joint springs
S.LWs = 2; % lines width springs
S.LWr = 4; % lines width rotators
